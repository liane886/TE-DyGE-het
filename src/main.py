...
from utils.data_helper2 import load_data,load_train_test
...
flags.DEFINE_string('train_prefix', 'FinKG', 'name of the object file that stores the training data. must be specified.')
...
flags.DEFINE_string('base_log_dir', '../logs/test', 'base directory for logging and saving embeddings')
...
# print('minibatch.adjs',minibatch.adjs)
# sess = tf.Session()
# sess.run(tf.Print(minibatch.adjs,[minibatch.adjs])) 

# adjs_info [13,1362,30], [12,1362,30], [13,1362,30], [15,1362,30], [15,1362,30], [13,1362,30], [8,1362,30]
