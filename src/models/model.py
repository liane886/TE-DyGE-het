...
class DyHATR(GeneralizedModel):
	...
	def edge_specific_sample(self, inputs, layer_infos, batch_size=None):
		...
		# print(self.num_graph_snapshots)
		# print(self.num_graph_views)
		# print("adjs",len(self.adjs))
		# print("adjs_j",len(self.adjs[0]))
		# print(samples_layer_snapshots_graphviews)
		# sess = tf.Session()
		# sess.run(tf.Print(self.adjs,[self.adjs]))

		# print(self.adjs[1][12])
		# print(self.adjs[2][0])
